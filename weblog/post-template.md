...
code { padding: .2em .3em; white-space: pre-wrap; word-wrap: break-word; background: var(--code-background); }
pre, code { font-family: 'MD IO 0.4'; font-size: 90%; border-radius: .5em; }
pre code { background: #000; color: #eee; display: inline-block; white-space: pre-wrap; word-wrap: break-word; }
img { max-width: 100%; }
...
.recent-posts, .recent-posts ul { padding-left: 1.2rem; }
</style>
</head>
<body>
